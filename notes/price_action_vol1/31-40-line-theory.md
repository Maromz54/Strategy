...
> ⚠️ **תיקון.** כתבתי כאן במקור שהגישה הנכונה היא "לייצר את כל הקווים באופן ממצה, לדרג
> ולחפש התכנסות". **זה הפוך מהשיטה.** שיעור L047 (`Reverse Engineering`) קובע מפורשות
> שמתחילים מ**אזור עניין** ורק אז מחפשים קווים שמצדיקים אותו, ושעבודת קווים היא **כלי
> אישוש ולא כלי לאיתור עסקאות**. ראה `41-50-convergence-procedure.md`.
